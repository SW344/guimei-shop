...
<body>
	<div id="container">
		...
		<div class="helpmenu f_l">
			<a href="#reg"><img src="img/reg.jpg" alt="alt" /><br />
				点此注册<br />
				认证中心<br />
			</a>
			<a href="#buy"><img src="img/buy.jpg" alt="alt" /><br />
		    咨询<br />
 			  投诉<br />
 	 		  举报<br />
  		  退款<br />		
			</a>
			<a href="#sale"><img src="img/sale.jpg" alt="alt" /><br />
 				安全中心<br />
				物流中心<br />
		    资金流动<br />
    		纠纷处理<br />
			</a>
			<a><img src="img/person.jpg" alt="alt" /></a>
		</div>
		<div class="help f_l">
			<div id="reg">
				<h2>知识堂首页 &gt;&gt; 注册＆认证 </h2>
				<p><img src="img/reg_line.jpg" alt="alt" /></p>
				<p>享受贵美网免费网上交易乐趣，并且在超人气的社区尽情交流您的网上购物经验，您需要先注册成为贵美的会员，具体的步骤如下：</p>
				<p><img src="img/reg_step.jpg" alt="alt" /></p>
				<ul type="square">
			...
			<div id="buy">
				...
				<h4>网上安全交易流程如下：</h4>
				<p><img src="img/buy_sep1.jpg" alt="alt" /></p>
				<h4>客户交易演示4步曲：</h4>
				<p><img src="img/buy_sep2.jpg" alt="alt" /></p>
			</div><!-- buy end -->
			<div id="sale">
				<h2>知识堂首页 &gt;&gt; 商家帮助 </h2>
				<p><img src="img/reg_line.jpg" alt="alt" /></p>
				<p>做贵美网的商家，拥有自己的个性小店，您需要了解贵美网上交易要点，请看出售商品的步骤：</p>
				<p><img src="img/sale_step.jpg" alt="alt" /></p>
			</div><!-- sale end -->			
		</div>
